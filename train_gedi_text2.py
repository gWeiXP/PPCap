...
def main():
    ...
    parser.add_argument("--code_0", type=str, default=" factual")
    parser.add_argument("--code_1", type=str, default=" romantic")
    ...
    parser.add_argument("--learning_rate", default=27.5e-5, type=float)
